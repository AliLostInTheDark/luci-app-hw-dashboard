...
return view.extend({
    ...
    render: function() {
        ...
        var cbiRow = function(labelTxt, field) {
            return E('div', { class: 'cbi-value hw-cbi-row' }, [
