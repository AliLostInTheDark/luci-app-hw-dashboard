...
return view.extend({
    ...
    render: function() {
        ...
        // Header: two inner panels that flex-wrap to column on narrow screens (≤600px)
        var _dskOvRow = E('div', {class: 'hw-dsk-inner-wrap'});
        var _dskDialArea = E('div', {class: 'hw-dsk-dial-box'});
        _dskDialArea.appendChild(_dskD);
        var _dskStatsArea = E('div', {class: 'hw-dsk-stats-box'});
        ...
        poll.add(function() {
            return callHwInfo().then(function(res) {
                ...
                (function() {
                    ...
                    if (hasUbi || hasMtd) {
                        var nandRow = E('div', {class: 'hw-thermals-container', style: 'align-items: flex-start;'});
